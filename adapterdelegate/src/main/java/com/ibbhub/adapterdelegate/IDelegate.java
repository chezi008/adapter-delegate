...
/**
 * @author ：chezi008 on 2018/8/18 9:31
 * @description ：
 * @email ：chezi008@163.com
 */
public interface IDelegate<T> {
    /**
     * Called to determine whether this IDelegate is the responsible for the given data
     * element.
     *
     ...
     */
    @NonNull  RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent);
